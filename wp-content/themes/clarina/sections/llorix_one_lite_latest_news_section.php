...
<?php
	...
	$clarina_ribbon_title = get_theme_mod('clarina_news_subtitle',esc_html__('Lorem ipsum dolor sit amet, consectetur adipiscing elit.','llorix-one-lite'));

	$llorix_one_lite_number_of_posts = get_option('posts_per_page');
	$args = array( 'post_type' => 'post', 'posts_per_page' => 3, 'order' => 'DESC','ignore_sticky_posts' => true );
						...
						<div class="container">
							<div class="row">
								...
								<?php
									...
									if( !empty($clarina_ribbon_title) || isset($wp_customize) ) {
										echo '<div class="latest-news-subtitle-wrap'. ( empty($clarina_ribbon_title) && isset($wp_customize) ? ' llorix_one_lite_only_customizer' : '' ) .'">' . $clarina_ribbon_title . '</div>';
									}
